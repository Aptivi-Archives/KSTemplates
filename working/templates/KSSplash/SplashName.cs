...
namespace KSCustomSplashTemplate
{
    ...
    public class SplashName : ISplash
    {
        ...
        {
            // Choose how would you like to update the progress warning report. This can be as simple as updating the area where progress percentage and text
            // is written, or you can increment the progress bar. This is called everytime the kernel issues a warning when it tries to make some progress while
            // booting.
        }
